...
from trimmy.apps.desktop.theme import (
    Colors,
    Radii,
    Spacing,
    Typography,
...
from trimmy.apps.desktop.views.editor_view import EditorView
from trimmy.apps.desktop.views.render_view import RenderView
from trimmy.apps.desktop.views.startup_view import StartupView
from trimmy.apps.desktop.widgets import CropWidget, PreviewWidget
...
from trimmy.preferences.application.load_preferences_use_case import (
    LoadPreferencesUseCase,
)
from trimmy.preferences.application.save_preferences_use_case import (
    SavePreferencesUseCase,
)
from trimmy.preferences.domain.models import Preferences, TargetPreference
...
class DesktopDependencies:
    """Ports and services selected by the desktop composition root."""

    presets: PresetRepository
    format_selector: FormatSelector
    aspect_calculator: AspectRatioCalculator
    probe: ProbeVideoUseCase
    preferences_repository: PreferencesRepository
    event_bus: EventBus
    rendering_backend_factory: Callable[[], RenderingBackend]
    crop_widget: CropWidget
    local_event_bus_factory: Callable[[], EventBus]
...
class RenderWorker(QThread):
    ...
    def __init__(
        ...
        self._local_event_bus_factory = local_event_bus_factory
    ...
    @override
    def run(self) -> None:
        local = self._local_event_bus_factory()
...
class MainWindow(QMainWindow):
    ...
    def __init__(
        ...
        self._aspect_calculator = dependencies.aspect_calculator
        self._probe = dependencies.probe
        self._prefs_repository = dependencies.preferences_repository
        self._rendering_backend_factory = dependencies.rendering_backend_factory
        self._crop_widget = dependencies.crop_widget
        self._local_event_bus_factory = dependencies.local_event_bus_factory
        ...
        self._bus = dependencies.event_bus
    ...
    def _build_ui(self) -> None:
        ...
        # Index 1: Editor view
        self._editor_view = EditorView(self._crop_widget)
    ...
    def _on_start_rendering(self, command: StartRendering | StartRenderQueue) -> None:
        ...
        self._render_worker = RenderWorker(
            ...
            self._presets,
            command,
            self._rendering_backend_factory(),
            self._local_event_bus_factory,
        )
